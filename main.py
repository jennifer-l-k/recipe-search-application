...
class App:
    ...
    def button_search_command(self):
        ...
        searched_recipes = self.db.fuzzy_search_recipes_by_ingredients(
            self.entry_enterfoodkey.get()
        )
    ...
    def show_selected_recipe(self, event):
        ...
        self.selected_recipe.configure(state="normal")
        self.selected_recipe.delete(1.0, tk.END)
        self.selected_recipe.tag_configure(
            "highlightLine", font="Bold", relief="raised"
        )
    ...
    def button_close_command(self):
        ...
        question_box = messagebox.askquestion(
        ...
        if question_box == "yes":
            ...
            tk.messagebox.showinfo(
                "Willkommen zurück", "Willkommen zurück in der Anwendung."
            )
    ...
    def button_help_command(self):
        ...
        messagebox.showinfo(
            "Hilfe",
            "Geben Sie ein beliebiges Lebensmittel in das Suchfeld ein und es werden Ihnen entsprechende Rezepte mit dem Lebensmittel ausgegeben.\n\nViel Spaß.",
        )
